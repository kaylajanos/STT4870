...
this document was last compiled Monday, February 17, 2014 - 12:10:46.
...
How about {\bfseries{R Code}} \vref{test-b} and \vref{test-c}?  The standard deviation of \texttt{x} is 0.9728.
...
Look at {\bfseries{R Code}} \vref{test-a} to add $1 + 1$ and get the answer 2. The output from {\bfseries{Git Example}} \vref{GITlabel} shows how my machine is configured. {\bfseries{Git Example}} \vref{gitlog} shows the log.
